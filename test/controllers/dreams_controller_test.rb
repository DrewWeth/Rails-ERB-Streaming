...
class DreamsControllerTest < ActionController::TestCase
  ...
  test "should create dream" do
    assert_difference('Dream.count') do
      post :create, dream: { completed: @dream.completed, content: @dream.content, timeline: @dream.timeline }
    end
  ...
  test "should update dream" do
    patch :update, id: @dream, dream: { completed: @dream.completed, content: @dream.content, timeline: @dream.timeline }
    assert_redirected_to dream_path(assigns(:dream))
  end
